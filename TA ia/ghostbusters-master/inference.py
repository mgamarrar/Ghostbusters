...
class ParticleFilter(InferenceModule):
    ...
    def getBeliefDistribution(self):
        ...
        for particle in result:
            suma+=result[particle]
            print(suma)
        
        beliefs=util.Counter()
        for position in self.legalPositions:
            quantity=self.particles.count(position)
            beliefs[position]=quantity
            print(n)
            print(quantity)
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        repetitions=self.numParticles/len(possiblePositions)
        for i in range(repetitions):
            self.particles.extend(possiblePositions)
...
#                self.particles = [self.getParticleWithGhostInJail(p, j) for p in self.particles]
#                for i in range(self.numParticles):
#                    self.particles.append(self.getJailPosition())
#        else:
#            flag=False
